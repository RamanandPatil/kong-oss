# Create Control Plane Helm values
cp_values = """# values-cp.yaml - Kong Control Plane Configuration
...
with open("kong-hybrid-setup/control-plane/values-cp.yaml", "w") as f:
    f.write(cp_values)

print("Control Plane Helm values created!")